    ...
    if request.method=="POST":
        if "image" in request.files:
            ...
            if image_file:
                ...
                player_info,palyer_name=celebrity_detector.identify(img_bytes)
            ...
            palyer_name=request.form["player_name"]
            player_info=request.form["player_info"]
            result_img_data=request.form["result_img_data"]

            answer=qa_engine.ask_about_celebrity(palyer_name,user_question)
